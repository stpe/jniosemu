...
public class CompilerITypeInstruction extends CompilerInstruction {
   ...
   */
  public CompilerITypeInstruction(InstructionInfo aInstructionInfo, String aArgs, int aLineNumber)
        ...
        if (mArgs.matches()) {
          try {
            ...
            throw new InstructionException(
                aInstructionInfo.getName(), "Wrong argument syntax: " + aArgs);
          }
  ...
  public int getOpcode() {
    return (this.rA & 0x1F) << 27
        | (this.rB & 0x1F) << 22
        | (this.imm & 0xFFFF) << 6
        | this.instructionInfo.getOpCode();
  }
  ...
  public void link(Hashtable<String, Integer> aLabels, int aAddr) throws InstructionException {
    long imm;
    try {
      if (this.instructionInfo.getSyntax() == InstructionInfo.Syntax.BRANCH
          || this.instructionInfo.getSyntax() == InstructionInfo.Syntax.BRANCH_COND) {
