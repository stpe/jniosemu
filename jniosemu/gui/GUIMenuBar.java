...
public class GUIMenuBar extends JMenuBar implements ActionListener {
  ...
  /** Delimter character used in action command to separate event from value. */
  ...
  private void setup(StateManager stateManager) {
    ...
    item =
        createMenuItem(
            "New",
            EventManager.EVENT.DOCUMENT_NEW.toString(),
    ...
    item =
        createMenuItem(
            "Open...",
            EventManager.EVENT.DOCUMENT_OPEN.toString(),
    ...
    item =
        createMenuItem(
            "Save",
            EventManager.EVENT.DOCUMENT_SAVE.toString(),
    ...
    item =
        createMenuItem(
            "Save As...",
            EventManager.EVENT.DOCUMENT_SAVE_AS.toString(),
    ...
    item =
        createMenuItem(
            "Undo",
            EventManager.EVENT.EDITOR_UNDO.toString(),
    ...
    item =
        createMenuItem(
            "Redo",
            EventManager.EVENT.EDITOR_REDO.toString(),
    ...
    item =
        createMenuItem(
            "Reset",
            EventManager.EVENT.EMULATOR_RESET.toString(),
    ...
    item.setActionCommand(
        EventManager.EVENT.EMULATOR_SPEED + DELIMITER_CHAR + EmulatorManager.SPEED.SLOW);
    item.addActionListener(this);
    speedGroup.add(item);
    submenu.add(item);
    ...
    item.setActionCommand(
        EventManager.EVENT.EMULATOR_SPEED + DELIMITER_CHAR + EmulatorManager.SPEED.NORMAL);
    item.addActionListener(this);
    speedGroup.add(item);
    submenu.add(item);
    ...
    item.setActionCommand(
        EventManager.EVENT.EMULATOR_SPEED + DELIMITER_CHAR + EmulatorManager.SPEED.FAST);
    item.addActionListener(this);
    speedGroup.add(item);
    submenu.add(item);
    ...
    item.setActionCommand(
        EventManager.EVENT.EMULATOR_SPEED + DELIMITER_CHAR + EmulatorManager.SPEED.ULTRA);
    item.addActionListener(this);
    speedGroup.add(item);
    submenu.add(item);
    ...
    item =
        createMenuItem(
            "Memory...",
            EventManager.EVENT.MEMORY_VIEW.toString(),
    ...
    item =
        createMenuItem(
            "UART 0...",
            EventManager.EVENT.UART0_VIEW.toString(),
    ...
    item =
        createMenuItem(
            "UART 1...",
            EventManager.EVENT.UART1_VIEW.toString(),
    ...
    item =
        createMenuItem(
            "Toggle Editor/Emulator",
            EventManager.EVENT.APPLICATION_TAB_TOGGLE.toString(),
  ...
  /**
   * Creates the Instruction menu that lists all available instructions categorized by
   * functionality. When a menu item is selected the corresponding instruction will be inserted into
   * the editor.
   *
   * @calledby setup()
   * @param stateManager reference to State Manager
