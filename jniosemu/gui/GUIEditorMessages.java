...
public class GUIEditorMessages extends JPanel implements EventObserver {
  ...
  public GUIEditorMessages(EventManager eventManager) {
    ...
    EventManager.EVENT[] events = {
      EventManager.EVENT.COMPILER_COMPILE, EventManager.EVENT.COMPILER_ERROR
    };
  ...
  private void setup() {
    ...
    /**
     * Add mouse listener to listen to double-clicks on a line to be able to move the caret in the
     * editor to the line number stated in the error message.
     */
          ...
          public void mouseClicked(MouseEvent e) {
            if (e.getClickCount() == 2) {
              ...
              eventManager.sendEvent(
                  EventManager.EVENT.EDITOR_MOVE_TO_LINE, Integer.valueOf(lineNumber));
            }
          }
        };
