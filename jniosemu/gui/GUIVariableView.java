...
public class GUIVariableView extends JFrame implements ActionListener, EventObserver {
  ...
  private void setup() {
    ...
    variableList.setCellRenderer(
        new VariableCellRenderer(variableList.getFontMetrics(variableList.getFont())));
  ...
  class VariableCellRenderer extends JPanel implements ListCellRenderer {
